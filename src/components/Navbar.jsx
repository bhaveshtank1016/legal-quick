...
import legallogo from "../assets/reallogo.png"
...
export default function Navbar() {
  ...
  return (
    <nav
      className={`w-full p-5 fixed top-0 left-0 z-50 transition-all duration-300 ${
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <img src={legallogo} alt="logo" className="w-auto h-10  "/>
