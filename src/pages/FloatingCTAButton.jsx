  ...
  return (
    ...
    hover:bg-yellow-600 text-white px-2 py-2 text-sm font-medium z-50 shadow-md border-l-2 border-yellow-700"
      ...
      <div className="fixed bottom-6 right-4 flex flex-col gap-3 z-50">
        ...
        <a
          href="tel:+919928182744"
          className="bg-blue-700 hover:bg-blue-600 text-white px-3 py-3 rounded-full shadow-lg flex items-center gap-2 text-sm font-medium"
        >
          <PhoneCall size={18} />
