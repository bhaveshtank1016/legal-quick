...
const stats = [
  {
    icon: <FaBriefcase size={30} className="text-yellow-400" />,
    label: "Projects Completed",
    value: 100,
    suffix: "+",
  },
  {
    icon: <FaSmile size={30} className="text-yellow-400" />,
  ...
  return (
    <section className="bg-gradient-to-br from-slate-50 to-blue-50 py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-blue-700 mb-4">Our Achievements</h2>
